  ...
  return (
    ...
    >
              ...
              return (
                ...
                >
                  ...
                  <select
                    value={ctx.game}
                    onChange={(e) =>
                      updateGame(ctx.id, e.target.value as GameType)
                    }
                    style={{
                      flex: 1,
                      background: "#13131e",
                  ...
                  >
                    {(Object.entries(GAME_NAMES) as [GameType, string][]).map(
                      ([key, name]) => (
                  ...
                  <button
                    ...
                    style={{
                      ...
                      border: "none",
                      color: contexts.length > 1 ? "#555" : "#222",
        ...
        <div style={{ width: 250, flexShrink: 0 }}>
          ...
          >
            <div>
              ...
              >
                switch every {(1000 / settings.frequencyHz).toFixed(0)} ms
              </div>
            </div>
            ...
            <div>
              ...
              >
                {(["cycle", "uniform-random"] as const).map((mode) => {
      ...
      >
        ...
        >
          PRESS A CONTEXT KEY TO ENTER A CONTEXT · ALL KEYS ROUTE TO THE ACTIVE
          CONTEXT
        </div>
